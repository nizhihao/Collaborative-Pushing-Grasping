...
'''
#########################################################################
plot.py: visualize the push and grasp policy's performance
    x axis: step number(0-12000)
    y axis: grasp success rate
    solid line means the grasp success
    dotted line means the push then grasp success
...
interval_size = 300 # Report performance over the last 300 training steps
max_plot_iteration = 12000 # Maximum number of training steps to report performance
